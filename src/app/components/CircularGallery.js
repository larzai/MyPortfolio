...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: `https://cdn.rifaldo.my.id/gallery/design1.png`, text: '' },
      { image: `https://cdn.rifaldo.my.id/gallery/design2.png`, text: '' },
      { image: `https://cdn.rifaldo.my.id/gallery/design3.png`, text: '' },
      { image: `https://cdn.rifaldo.my.id/gallery/design4.png`, text: '' },
      { image: `https://cdn.rifaldo.my.id/gallery/design5.png`, text: '' }
    ];

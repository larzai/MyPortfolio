    ...
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        <section className={styles.hero}>
          <div
            ...
            <div className={styles.mainWrapper}>
              ...
              <h1 className={styles.saputra}>SAPUTRA</h1>
              <span className={styles.labelBottom}>{t.welcome}</span>
            </div>
          </div>
        ...
        >
          ...
          <a className={styles.buttonHomeAbout} onClick={() => go("/about")}>{t.buttonHomeAbout}</a>
        </section>
        ...
        <section className={styles.homeSelf}>
          ...
          <div className={styles.homeSelfCenter}>
            <motion.h1
              ...
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
            >{t.homeSelfTitle}</motion.h1>
            <motion.h2
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
            >{t.homeSelfSubtitle}</motion.h2>
          </div>
          <div className={styles.homeSelfBottom}>
            <motion.p
              ...
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.6 }}
            >{t.homeSelfParagraph1}</motion.p>
            <div className={styles.star10}></div>
            <motion.p
              initial={{ opacity: 0, x: 30 }}
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.6 }}
            >{t.homeSelfParagraph2}</motion.p>
          </div>
        </section>
        <section className={styles.homeBestProject}>
          ...
          >
            <h1>
            {t.homeBestProjectTitle1}<br/>
            <span>{t.homeBestProjectTitle2}</span><br/>
          ...
          <div className={styles.homeBestProjectGallery}>
            <motion.a
              ...
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.6 }}
            >{t.buttonHomeProjectGallery}</motion.a>
        ...
        <section className={styles.homeContactMe}>
          <a onClick={() => go("/contact")}>
            <motion.h1
              ...
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
            >{t.homeContactMeTitle}</motion.h1>
            <motion.h2
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
            >{t.homeContactMeSubtitle}</motion.h2>
          </a>
        </section>
        <Footer />
      </main>
